# Dfns Wallet for [Polkadot](https://polkadot.js.org/docs/api/start)

Dfns wallet integration with Polkadot{.js} (https://polkadot.js.org/docs/api/start), makes working with Polkadot as simple and painless as possible.
...
Go checkout the [examples](../../examples/libs/polkadot) we have that showcase how you can start developing dapps with Dfns wallets.
