# Dfns Wallet for [Algorand](https://algorand.github.io/js-algorand-sdk/modules.html)

Dfns wallet integration with Algorand algosdk (https://algorand.github.io/js-algorand-sdk/modules.html), makes working with Algorand as simple and painless as possible.
...
Go checkout the [examples](../../examples/libs/algorand) we have that showcase how you can start developing dapps with Dfns wallets.
