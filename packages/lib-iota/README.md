# Dfns Wallet for [Iota](https://docs.iota.org/ts-sdk/typescript/)

Dfns wallet integration with Iota-sdk (https://docs.iota.org/ts-sdk/typescript/), makes working with Iota as simple and painless as possible.
...
Go checkout the [examples](../../examples/libs/iota) we have that showcase how you can start developing dapps with Dfns wallets.
