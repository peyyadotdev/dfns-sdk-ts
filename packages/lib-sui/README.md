# Dfns Wallet for [Sui](https://docs.sui.io/)

Dfns wallet integration with Sui SDK (https://docs.sui.io/), makes working with Sui as simple and painless as possible.
...
Go checkout the [examples](../../examples/libs/sui) we have that showcase how you can start developing dapps with Dfns wallets.
